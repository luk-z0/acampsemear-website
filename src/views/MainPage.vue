<template>
  ...
  <!-- <div class="relative">
    <div class="flex  bg-light-khaki w-full min-h-full">
      <div class="flex flex-wrap w-1/2 p-40 pt-26">
      ...
      <div class="absolute translate-x-full w-1/2 h-full">
        <div class="flex items-center justify-center h-full">
          <div class="rounded-md w-3/4 h-2/4 bg-mossgreen">
            <div class="flex items-center justify-center">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/FMrtSHAAPhM?si=0PkGxa-Q-AYu83SV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>                
