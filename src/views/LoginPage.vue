                ...
                <div class="flex absolute min-h-full flex-1 flex-col justify-center lg:px-8">
                    ...
                    px-16 py-12 shadow-lg">
                        ...
                        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form class="space-y-6" @submit.prevent="getHome">
                                ...
                                <div>
                                    <button type="submit"
                                        class="flex w-full justify-center rounded-md bg-olive-black px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                        Entrar
                                    </button>
                                </div>
                            </form>
