<template>
    <FormComponent>
        <div class="flex-1 flex-col justify-center p-24 dim:px-12">
            <div class="flex flex-col w-auto h-auto">
                ...
                <div class="flex flex-col mt-10 sm:mx-auto sm:w-full sm:max-w-sm sm:max-h-max">
...
const login = async () => {
   const data = await auth.login(userAuth); 
